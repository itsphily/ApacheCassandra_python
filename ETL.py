'''
Running this script will create an ETL pipeline. The data will be loaded into 3 tables.
These tables have been modeled to optimize 3 different types of queries. Once loaded, 3 queries will be run on the tables
refer to the Readme.md file for more information on the queries and how the table have been modeled.
